...
- Theming: `lib/app/theme/`. Material 3 seeded `ColorScheme`, light and dark, plus `AppSemanticColors` theme extension. Platform-adaptive widgets live in `lib/shared/widgets/adaptive/`.
...
lib/
  ...
  services/                        push notifications and other platform services
  shared/widgets/                  reusable UI (adaptive, buttons, feedback)
```
